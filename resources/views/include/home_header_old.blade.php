            ...
            <div class="top-info hidden-sm-down">
                ...
                <div class="address-header">
                    <p><i class="fa fa-map-marker" aria-hidden="true"></i><span style="color:black"> 
                        Gloryinvestmentlimited Schluhmattstrasse 55, Zermatt 3920 Switzerland
                    </span></p>
                </div>
                ...
                <ul>
                    ...
                    <a href="{{route('app.home')}}"  aria-expanded="false" >
                        <li class="hidden-lg-up">
                            <div class="po" style="color: white">
                                HOME
                            </div>
                        </li>
                    </a>
                    ...
                    <!-- END COLLAPSE MOBILE MENU -->
                    <li class="dropdown hidden-md-down">
                        <a class="" aria-haspopup="true" aria-expanded="false" href="{{route('charity')}}" style="color: white">CHARITY</a>
                    ...
                    <!-- END COLLAPSE MOBILE MENU -->
                    <li class="dropdown hidden-md-down">
                        <a class="" aria-haspopup="true" aria-expanded="false" href="{{route('user.login')}}" style="color: white">LOGIN</a>
