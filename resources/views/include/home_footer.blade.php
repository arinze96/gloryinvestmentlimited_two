            ...
            <div class="col-lg-5 col-md-6 wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.6s">
                <div class="footer-box">
                    ...
                    <div class="social-style">
                        ...
                        <a href="https://twitter.com/GloryInvestmen3?t=5K83z3TL7UfrYjdxHE9mdg&s=09"><i class="fab fa-twitter"></i></a>
                        <a href="whatsapp://send?abid=+447944113431&text=Hello"><i class="fab fa-whatsapp"></i></a>
                        <a href="https://www.instagram.com/gloryinvestment2014"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center wow fadeInUp" data-wow-duration="0.4s" data-wow-delay="0.4s">
                <div class="footer-bottom">
                    <p class="text">Copyright &copy; <a href="#">Gloryinvestmentlimited</a> | <a
                            href="#">2023</a>
                    </p>
                </div>
            </div>
