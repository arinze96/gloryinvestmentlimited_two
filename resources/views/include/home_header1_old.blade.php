        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('app.home') }}" style="color: white">Home</a>
                    </li>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="list">
                                ...
                                <div class="item"><a style="text-decoration: none; color: black"
                                        ...
                                        <div class="item"><a style="text-decoration: none; color: black"
                                            href="{{ route('user.certificates') }}">Our Certificates</a></div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('charity') }}" style="color: white">Charity</a>
                    </li>
