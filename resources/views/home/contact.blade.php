...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/new/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new/assets/css/templatemo-host-cloud.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/new/assets/css/owl.css') }}">
<!--
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Contact Us</h1>
            <p><a href="{{ route('app.home') }}">Home</a> / <span>Contact Us</span></p>
          </div>
        </div>
      </div>
    </div>
...
-->
    ...
    <!-- Additional Scripts -->
    <script src="{{ asset('assets/new/assets/js/custom.js') }}"></script>
    <script src="{{ asset('assets/new/assets/js/owl.js') }}"></script>
    <script src="{{ asset('assets/new/assets/js/accordions.js') }}"></script>
